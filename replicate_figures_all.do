...
set linesize 180
set logtype text
log using  "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\create-cps-figures.log" , replace
...
*exit
use "C:\Users\yegor\Desktop\Econ 580\Assignment 2\DataClean\cps_DDD_FINAL.dta", clear
...
preserve
	...
	twoway (bar height diff1 if (treat == 0), barwidth(0.005) fcolor(gs10) ) ///
		...
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\working_histo-allus.gph" , replace
 restore
...
preserve
	...
	twoway (bar height diff3 if (treat == 0), barwidth(0.005) fcolor(gs10) ) ///
		...
		yscale( nofextend ) xscale(nofextend) ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_private_histo-allus.gph" , replace
restore
...
preserve
	...
	twoway (bar height diff1 if (treat == 0), barwidth(0.005) fcolor(gs10) ) ///
		...
		yscale( nofextend ) xscale(nofextend) ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_public_histo-allus.gph" , replace
restore
...
preserve
	...
	twoway (bar height diff1 if (treat == 0), barwidth(0.005) fcolor(gs10) ) ///
		...
		yscale( nofextend ) xscale(nofextend) ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\working_histo.gph" , replace
 restore
...
preserve
	...
	twoway (bar height diff3 if (treat == 0), barwidth(0.005) fcolor(gs10) ) ///
		...
		yscale( nofextend ) xscale(nofextend) ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_private_histo.gph" , replace
restore
...
preserve
	...
	twoway (bar height diff1 if (treat == 0), barwidth(0.005) fcolor(gs10) ) ///
		...
		yscale( nofextend ) xscale(nofextend) ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_public_histo.gph" , replace
restore
...
preserve
	...
	** Given small cells, we present the raw data in two-year means
	...
	twoway ///
		...
		xtitle(" ") ytitle(" ") 
	 graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_public_kid-allus.gph", replace
	...
	twoway ///
		...
		xlabel(2000 "2000-2001" 2002 "2002-2003" 2004 "2004-2005" 2006 "2006-07") ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_private_kid-allus.gph", replace
	...
	twoway ///
		...
		xlabel(2000 "2000-2001" 2002 "2002-2003" 2004 "2004-2005" 2006 "2006-07") ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\working_kid-allus.gph", replace
...
preserve
	...
	** Given small cells, we present the raw data in two-year means
	...
	twoway ///
		...
		xlabel(2000 "2000-2001" 2002 "2002-2003" 2004 "2004-2005" 2006 "2006-07") ///
		xtitle(" ") ytitle(" ") 
	 graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_public_kid.gph", replace
	...
	twoway ///
		...
		xlabel(2000 "2000-2001" 2002 "2002-2003" 2004 "2004-2005" 2006 "2006-07") ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_private_kid.gph", replace
	...
	twoway ///
		...
		xlabel(2000 "2000-2001" 2002 "2002-2003" 2004 "2004-2005" 2006 "2006-07") ///
		xtitle(" ") ytitle(" ") 
	graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\working_kid.gph", replace
...
preserve
	...
	twoway ///
	 ...
	 (connected any_public year if tn == 1 & kid == 0, lpattern(solid) lcolor(gray) mcolor(blue) msymbol(o) ) ///
		...
		xtitle(" ") ytitle(" ") 
	 graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_public_kid-longterm.gph", replace
	...
	twoway ///
	 ...
	 (connected any_private year if tn == 1 & kid == 0, lpattern(solid) lcolor(gray) mcolor(blue) msymbol(o) ) ///
		...
		xlabel(1998 "1998-1999" 2000 "2000-2001" 2002 "2002-2003" 2004 "2004-2005" 2006 "2006-2007" 2008 "2008-2009" 2010 "2010-11") ///
		xtitle(" ") ytitle(" ") 
	 graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_private_kid-longterm.gph", replace
	...
	twoway ///
	 ...
	 (connected working year if tn == 1 & kid == 0, lpattern(solid) lcolor(gray) mcolor(blue) msymbol(o) ) ///
		...
		xlabel(1998 "1998-1999" 2000 "2000-2001" 2002 "2002-2003" 2004 "2004-2005" 2006 "2006-2007" 2008 "2008-2009" 2010 "2010-11") ///
		xtitle(" ") ytitle(" ") 
	 graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\working_kid-longterm.gph", replace
...
preserve
	...
	twoway ///
	 ...
	 graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_public.gph", replace
	...
	twoway ///
	 ...
	 graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\any_private.gph", replace
	...
	twoway ///
	 ...
	 , /// 
	  ylabel(0.66(0.02)0.78, axis(1) nogrid angle(horizontal)) ylabel(0.64(0.02)0.76, axis(2) angle(horizontal)) ///
		...
		xlabel(2000 "2000-2001" 2002 "2002-2003" 2004 "2004-2005" 2006 "2006-2007") ///
		xtitle(" ") ytitle(" ", axis(1) ) ytitle(" ", axis(2) ) 
	 graph save "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\working.gph", replace
...
twoway ///
	(connected evt_coeffs year, lpattern(solid) lcolor(gray) mcolor(blue) msymbol(o)) /// 
		...
		xtitle(" ") ytitle(" ") 
	graph "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\event_study_working.gph", replace
	graph export "C:\Users\yegor\Desktop\Econ 580\Assignment 2\gph\event_study_working.gph", replace
